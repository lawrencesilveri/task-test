...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _posts_posts_component__WEBPACK_IMPORTED_MODULE_7__["PostsComponent"]],
...
var PostsComponent = /** @class */ (function () {
    ...
    PostsComponent.prototype.create = function () {
        var _this = this;
        this.postService.createPost(this.text.value).subscribe(function (post) {
            // console.log(post);
            _this.getPosts();
            _this.text = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('');
        });
    };
    PostsComponent.prototype.upVote = function (id) {
        var _this = this;
        this.postService.patchPostById(id).subscribe(function (post) {
            // console.log(post);
            _this.getPosts();
        });
    };
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.createPost = function (text) {
        return this.http.post(this.apiURL, { text: text });
    };
    PostService.prototype.patchPostById = function (id) {
...
module.exports = __webpack_require__(/*! D:\PROJECTS\Completed\taskPosts\src\main.ts */"./src/main.ts");
